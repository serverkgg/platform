...
summary: "Realistic numbers by player count, plugins and mods — so you never pay for RAM you will not use."
---
...
Instead of guessing: the [server planner](/tools/planner?game=minecraft) asks for the game, the player count and how you play — no plugins, light plugins, or a heavy modpack — and gives you the right plan, its final price, and what that works out to per person per month.

- [Size your plan now](/tools/planner?game=minecraft)
- [Compare our prices with the rest](/compare)
- [Create your server](/create)
